...
CREATE TABLE `categoryes` (
  ...
  `category_discount` tinyint(2) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
LOCK TABLES `categoryes` WRITE;
/*!40000 ALTER TABLE `categoryes` DISABLE KEYS */;
INSERT INTO `categoryes` VALUES (1,'women',NULL),(2,'men',NULL),(3,'kids',NULL);
/*!40000 ALTER TABLE `categoryes` ENABLE KEYS */;
UNLOCK TABLES;
